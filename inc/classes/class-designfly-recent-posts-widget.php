...
/**
 * Designfly Recent Post Widget
 */
class Designfly_Recent_Posts_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			'classname'   => 'designfly-recent-posts-widget',
			'description' => 'Recent Posts Widget',
		);
		parent::__construct( 'designfly_recent_posts', 'Designfly Recent Posts', $widget_ops ); // WPCS: XSS OK.
