...
namespace DESIGNFLY\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( DESIGNFLY_TEMP_DIR ), $directory, $file_name );
...
spl_autoload_register( '\DESIGNFLY\Inc\Helpers\autoloader' );
